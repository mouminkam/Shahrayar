...
const VerifyResetTokenContent = dynamic(
  () =>
    import(
      "../../../components/pages/verify-reset-token/VerifyResetTokenContent"
    ),
  {
...
export const metadata: Metadata = { title: "Verify Reset Token" };
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="max-w-2xl mx-auto">
              <ErrorBoundary>
                <Suspense
                  fallback={
                    <SectionSkeleton variant="default" height="h-96" />
                  }
                >
                  <AnimatedSection>
